...
<section class="container mx-auto p-4 mt-4">
      ...
      <a class="block p-4 text-blue-700" href="/public/listings/">
        <i class="fa fa-arrow-alt-circle-left"></i>
        Back To Listings
      </a>
      <div class="flex space-x-4 ml-4">
        <a href="/public/listings/edit/<?php $listing -> id ?>" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
        <!-- Delete Form -->
        <form method="POST">
